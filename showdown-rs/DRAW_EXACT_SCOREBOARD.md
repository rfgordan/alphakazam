...
## Burn-down summary
56.98% → **86.43%** over 10 committed classes (+29.45 pts, +1128 units). Fix-decay curve is
healthy: each class landed a real, structured, decaying slice (207, 282, 132, 206, 62, 19,
29, 32, 150, 9 units) with **no** new independent mismatch class revealed per fix beyond the known
queue — kill-criterion #2 (non-decaying density) is **not** triggered. All 10 classes are
