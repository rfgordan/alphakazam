...
## Burn-down summary
56.98% → **86.64%** over 11 committed classes (+29.66 pts, +1136 units). Fix-decay curve is
healthy: each class landed a real, structured, decaying slice (207, 282, 132, 206, 62, 19,
29, 32, 150, 9, 8 units) with **no** new independent mismatch class revealed per fix beyond the known
queue — kill-criterion #2 (non-decaying density) is **not** triggered. All 11 classes are
